...
//Create variables to hold number of wins, losses, sessions
var wins = 0;
var losses = 0;
var guessesLeft = 10;
...
alert("Welcome.  I have console.logged the computer choices if you would like to cheat the system.");
...
document.onkeyup = function(event) {
    ...
    // ********Tried to refactor this into function outside of onkeyup but couldn't get it to work.  Don't really understand why.********
    ...
    //Evaluate userGuess vs. compterChoice 
    if (sessionsLeft === 0) {
        resetPage();
